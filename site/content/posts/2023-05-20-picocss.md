...
Now, let's try to add pico.css to your application. I've generated app with importmaps, so I cannot add pico.css as an `npm` package, but if you use `cssbundling-rails` gem - you'll have no limitation. There are [3 ways to use pico.css with your app](https://picocss.com/docs/):
...
![](/images/2023-05-20-picocss/1.png)

Well, not bad, comparing to default style

![](/images/2023-05-20-picocss/2.png)
...
![](/images/2023-05-20-picocss/3.png)
