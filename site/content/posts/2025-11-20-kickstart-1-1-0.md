...
pubDate: 2025-11-20
tags: ['ruby on rails', 'ruby', 'development automation', 'react', 'vue', 'svelte', 'open source']
---

I'm happy to announce Kickstart 1.1.0, now with strawberry flavour, damn - with `inertia_rails` support :)
