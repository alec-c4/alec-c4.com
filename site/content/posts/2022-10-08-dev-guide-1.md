...
description: 'First article in the series on how to manage development processes'
pubDate: 2022-10-08
...
6. The code must be inherently high performance
...
6. Duration of the task must not be more than 1 day. If the task is longer, it must be divided into small tasks.
