---
title: 'Spaceship'
description: 'Premium, high-performance blog and portfolio template built with Astro 5, Svelte 5, and Tailwind CSS 4.'
link: 'https://spaceship-one.vercel.app'
github: 'https://github.com/alec-c4/spaceship'
tags: ['Astro', 'Svelte 5', 'Tailwind 4']
types: ['open-source']
order: 2
---

Spaceship is built with **Astro 5**, **Svelte 5 Runes**, and **Tailwind CSS 4**, designed for developers and designers who want a modern, ultra-fast, and SEO-optimized web experience.
