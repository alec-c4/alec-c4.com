...
postSlug: 2024-02-22-digital-true-crime-rus
featured: false
draft: false
tags:
  - social projects
  - социальные проекты
  - russian
description: Идея проекта crowd crime investigation
---
...
1. Код должен быть доступен любому, что желает провести аудит его на наличие уязвимостей, то есть опубликован под одной из open source лицензий.
